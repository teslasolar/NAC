...
const orgData = {
  rowOfficers: [
    ...
    { id: 'district-attorney', name: "District Attorney", officer: 'Stephen G. Baratta', category: 'row-officer', budget: 8500000, staff: 89, oee: 68.2,
    ...
    { id: 'recorder-of-deeds', name: "Recorder of Deeds", officer: 'Dorothy Edelman', category: 'row-officer', budget: 1450000, staff: 15, oee: 82.1,
  ...
  executive: [
    { id: 'county-executive', name: "County Executive Office", officer: 'Tara Zrinski', category: 'administrative', budget: 3200000, staff: 28,
